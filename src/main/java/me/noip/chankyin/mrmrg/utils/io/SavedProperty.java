...
public @interface SavedProperty{
	public final static short VERSION_NIL = -1;
	...
	/**
	 * Returns the version ID of the database version that removed this property , i.e. the earliest version after adding this property that this property does not exist.
	 *
